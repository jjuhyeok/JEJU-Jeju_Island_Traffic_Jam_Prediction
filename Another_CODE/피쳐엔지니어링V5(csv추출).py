...
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 30)] = 'b'
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 40)] = 'b'
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 50)] = 'b'
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 60)] = 'a'
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 70)] = 'a'
train_x['maximum_speed_limit'][(train_x['maximum_speed_limit'] == 80)] = 'a'

test_x['maximum_speed_limit'][(test_x['maximum_speed_limit'] == 30)] = 'b'
test_x['maximum_speed_limit'][(test_x['maximum_speed_limit'] == 40)] = 'b'
test_x['maximum_speed_limit'][(test_x['maximum_speed_limit'] == 50)] = 'b'
test_x['maximum_speed_limit'][(test_x['maximum_speed_limit'] == 60)] = 'a'
test_x['maximum_speed_limit'][(test_x['maximum_speed_limit'] == 70)] = 'a'
...
train_x['weight_restricted'][(train_x['weight_restricted'] == 0)] = 'b'
train_x['weight_restricted'][(train_x['weight_restricted'] == 32400)] = 'a'
train_x['weight_restricted'][(train_x['weight_restricted'] == 43200)] = 'a'
train_x['weight_restricted'][(train_x['weight_restricted'] == 50000)] = 'a'


test_x['weight_restricted'][(test_x['weight_restricted'] == 0)] = 'b'
test_x['weight_restricted'][(test_x['weight_restricted'] == 32400)] = 'a'
test_x['weight_restricted'][(test_x['weight_restricted'] == 43200)] = 'a'
test_x['weight_restricted'][(test_x['weight_restricted'] == 50000)] = ''
...
#금토는 많이 막힐것
train_x['day_of_week'][(train_x['day_of_week'] == '월')] = 'a'
...
train_x['day_of_week'][(train_x['day_of_week'] == '금')] = 'b'
train_x['day_of_week'][(train_x['day_of_week'] == '토')] = 'b'
train_x['day_of_week'][(train_x['day_of_week'] == '일')] = 'b'



test_x['day_of_week'][(test_x['day_of_week'] == '월')] = 'a'
...
test_x['day_of_week'][(test_x['day_of_week'] == '금')] = 'b'
test_x['day_of_week'][(test_x['day_of_week'] == '토')] = 'b'
...
train_x.to_csv("EngineeringV5_train_x.csv", index = False)
train_y.to_csv("EngineeringV5_train_y.csv", index = False)
test_x.to_csv("EngineeringV5_test_x.csv", index = False)
...
plot_model(model_dt, plot = 'feature')

interpret_model(model_dt)
