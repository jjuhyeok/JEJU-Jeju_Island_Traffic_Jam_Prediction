...
lgbm_train_pred = pd.read_csv('lgbm_train_pred2.csv')
...
lgbm_test_pred = pd.read_csv('lgbm_test_pred2.csv')
...
huber_param = {'epsilon': 1.057323959768329, 'max_iter': 260, 'alpha': 0.01898372708591808}
lr_final = HuberRegressor(**huber_param)
lr_final.fit(Stack_final_X_train, y)
stack_final = lr_final.predict(Stack_final_X_test)

submit['target'] = stack_final
submit.to_csv('stacking_meta_huber2.csv', index = False)
