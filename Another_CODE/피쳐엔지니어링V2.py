...
train_x['node_TF'][X['node_TF'] == True] = '1'
train_x['node_TF'][X['node_TF'] == False] = '0'
test_x['node_TF'][test['node_TF'] == True] = '1'
test_x['node_TF'][test['node_TF'] == False] = '0'

print(X['node_TF'])

train_x['node_TF'] = pd.to_numeric(X['node_TF'])
test_x['node_TF'] = pd.to_numeric(test['node_TF'])
